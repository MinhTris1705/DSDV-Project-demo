(function(d3) {
    ...
    fetch('https://raw.githubusercontent.com/MinhTris1705/DSDV-Project-demo/main/datasets/Median_age.csv')
        ...
        .then(data => {
            ...
            var svg = d3v4.select("#median-age-graph")
                .append("svg")
            ...
            var dataParsed = d3v4.csvParse(data, rowConverter);

            var bisectYear = d3v4.bisector(function(d) { return d.Year; }).left;
            ...
            var x = d3v4.scaleLinear()
                .domain(d3v4.extent(dataParsed, function(d) { return d.Year; }))
                .range([0, width]);

            var xAxisGenerator = d3v4.axisBottom(x)
            ...
            var y = d3v4.scaleLinear()
                .domain([15, d3v4.max(dataParsed, function(d) { return d.Median_age; })])
                .range([height, 0]);
                    ...
                    d3v4.selectAll(".mouse-per-line")
                        .attr("transform", function(d, i) {
                            var xYear = x.invert(mouse[0]),
                                bisect = d3v4.bisector(function(d) { return d.Year; }).left;
